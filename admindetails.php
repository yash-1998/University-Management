        	...
        	<form action="login.php" method="POST">
          		<div class="form-group" >
					<label for="adminname">First Name : &nbsp;&nbsp;&nbsp;</label>
			  		<input class="form-control" type="text" value=<?php echo $_SESSION['adminfirst']?> id="adminname" readonly>
				</div>
				<div class="form-group">
					<label for="adminlast">Last Name : &nbsp;&nbsp;&nbsp;</label>
			  		<input class="form-control" type="text" value=<?php echo $_SESSION['adminlast']?> id="adminlast" readonly>
				</div>
				<div class="form-group">
					<label for="adminuser">Username : &nbsp;&nbsp;&nbsp;&nbsp;</label>
			  		<input class="form-control" type="text" value=<?php echo $_SESSION['username']?> id="adminuser" readonly>
				</div>
				<div class="form-group">
					<label for="adminemail">Email : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
				  	<input class="form-control" type="text" value=<?php echo $_SESSION['adminemail']?> id="adminuser" readonly>
				</div>
			</form>
      		</div>
    	</div>
