  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <form class="form-inline my-2 my-lg-0 mr-lg-2" style="height: 50px">
            <div class="input-group">
              <input class="form-control" type="text" placeholder="Enter Enrollment No">
              <span class="input-group-append">
              &nbsp;&nbsp;&nbsp;
                <button class="btn btn-primary" type="button" >Find/Edit</button>
                &nbsp;&nbsp;&nbsp;
                 <button class="btn btn-primary" type="button" style = "background: green">Add New</button>
              </span>
            </div>
          </form>
