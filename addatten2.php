	...
	<div class="container-fluid">
		...
		<div class="container">
			...
			<form action="addatten2.php" method="POST">
				<label for="maxclasses">Enter the total number of classes for <?php echo $_SESSION['selectedcourse'];?> </label>
                <input name="maxclasses" class ="attsearch" type="number" id="maxclasses" type="number" step="1" value="" required>
			<div class="card mb-3">
				<br class="card-body">
