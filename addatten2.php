                ...
                <div class="table-responsive" style="background-color : #ede1c7">
                    <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                        ...
                        <tr style="background-color : #20c997">
                            ...
                            <th class="text-center">Enter Attendence</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
                            ...
                            while($row = mysqli_fetch_array($rs))
                            {
                                ...
                                echo '<tr style="background-color: #495057">
                                    <td class="text-center text-white">'.$count.'</td>
                                    ...
                                    if($rowcount>0)
                                    {
                                        ...
                                        <td  class="text-center text-white"><input style="text-align:center;" name='.$enno.' type="number" value='.$pr.' required></td>
                                        </tr>';
                                    }
                                    else
                                    {
										echo '<td class="text-center text-white">' . $row2['FirstName'] . ' ' . $row2['LastName'] . '</td>
                                        <td  class="text-center text-white"><input style="text-align:center;" name=' . $enno . ' type="number" placeholder="Add attendence" required></td>
                                        </tr>';
									}
                                $count=$count+1;
                            }
