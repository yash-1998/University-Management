        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb" style="background-color: #343a40" >
           ...
           <li id="editbtn" class="card text-white bg-primary">
                <a class="text-white" href="edit_student.php"s >
          ...
          <div style="align-content: center;">
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
              <img src="<?php echo $_SESSION['imagepath']?>" style="width:20%;height:35%;"  border="5">
          </div>
          ...
          <div class="form-group">
			  ...
			  $enno = $_SESSION['roll'];
			  $sql = "Select CourseName,Type from studentcourse where Enno='$enno'";
